...
class Storage {
   ...
   */
  async list (filePath) {
    if (typeof this._listFolder !== 'function' || typeof this._fileExists !== 'function') {
      throw new StorageError('method not implemented', StorageError.codes.NotImplemented)
    }
  ...
  async delete (filePath, options = {}) {
    if (typeof this._deleteFile !== 'function') {
      throw new StorageError('method not implemented', StorageError.codes.NotImplemented)
    }
    validateFilePath(filePath)
  ...
  async createWriteStream (filePath) {
    if (typeof this._createWriteStream !== 'function') {
      throw new StorageError('method not implemented', StorageError.codes.NotImplemented)
    }
    validateFilePath(filePath)
  ...
  async write (filePath, content) {
    ...
    if (content instanceof stream.Readable) {
      if (typeof this._writeStream !== 'function') {
        throw new StorageError('method not implemented', StorageError.codes.NotImplemented)
      }
      return this._writeStream(filePath, content)
    } else {
      if (typeof this._writeBuffer !== 'function') {
        throw new StorageError('method not implemented', StorageError.codes.NotImplemented)
      }
  ...
  async copy (srcPath, destPath, options = {}) {
    ...
    const _copyRemoteToRemote = async (srcPath, destPath, options) => {
      ...
      if (srcFiles.length === 0) throw new StorageError(`remote src '${srcPath}' cannot be copied as it does not exist`, StorageError.codes.FileNotExists)
